...
<div class="flex flex-row h-dvh">
    <div class="basis-1/2 relative">
        <div class="absolute flex flex-col top-1/3 left-1/3 w-1/2 h-auto">
            ...
            <div class="mb-4">
                <label for="username" class="block text-sm font-medium text-gray-600">User Email</label>
                <input type="text" id="username" name="username" class="mt-1  w-full  border border-black text-xs p-1  text-center" placeholder="Enter Your Valid Email">
            </div>
...
<label class="relative inline-flex items-center cursor-pointer mt-4">
    ...
    <span class="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">Verified Email</span>
  </label>
    ...
    <div class="basis-1/2  relative">
        <div class="absolute flex flex-col top-1/3 right-1/3 w-1/2 h-auto">
            <div class="mb-4">
                <label for="username" class="block text-sm font-medium text-gray-600"> Name</label>
                <input type="text" id="username" name="username" class="mt-1  w-full  border border-black text-xs p-1  text-center" placeholder="Enter Your Name ">
            </div>
            <div class="mb-2">
                <label for="username" class="block text-sm font-medium text-gray-600">User Id</label>
                <input type="text" id="username" name="username" class="mt-1  w-full  border border-black text-xs p-1  text-center" placeholder="Leave to Empty Autogenerate">
            </div>
