...
<div class="flex flex-row h-dvh ">
   ...
   <div class="  basis-3/5 relative bg-white ">
     <div class="flex flex-col justify-center h-auto w-1/3 top-1/3 left-1/3 absolute ">
        <h2 class="text-2xl font-bold mb-6 text-center">Sign In</h2>
        <div class="mb-1">
            <label for="username" class="block text-sm font-medium text-gray-600">User Name</label>
            <input type="text" id="username" name="username" class="mt-1  w-full  border border-black text-xs p-1  text-center" placeholder="Enter your username">
        </div>
        <div class="mb-1">
